...
import type { ApprovedAuthenticationRequest, ChallengeRequest, RevokeAuthenticationRequest, SignedAuthChallenge, VerifyRequest, WalletAuthenticationToProfileAuthenticationRequest } from "../graphql/types.generated.js";
...
export declare class Authentication implements IAuthentication {
    ...
    verify(request: string | VerifyRequest): Promise<boolean>;
